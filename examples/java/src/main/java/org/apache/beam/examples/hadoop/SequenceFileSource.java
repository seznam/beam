...
public class SequenceFileSource<K, V> extends FileBasedSource<KV<K, V>> {
  ...
  private static final Logger log = LoggerFactory.getLogger(SequenceFileSource.class);
   ...
   * {@inheritDoc}
   *
   * @deprecated {@link Source#getDefaultOutputCoder()}
   */
  @Deprecated
  @Override
  ...
  static class SeqFileReader<K, V> extends FileBasedReader<KV<K, V>> {
    ...
    protected boolean readNextRecord() throws IOException {
      ...
      final K key = ReflectionUtils.newInstance(keyClass, null);

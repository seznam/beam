 ...
 */
package org.apache.beam.examples.hadoop;
 ...
 * @see <a
 *     href="https://github.com/googleapis/cloud-bigtable-client/tree/master/bigtable-dataflow-parent/bigtable-beam-import/src/main/java/com/google/cloud/bigtable/beam/sequencefiles">original
 *     source</a>
 */
public class HadoopSerializationCoder<T> extends CustomCoder<T> {
  ...
  public HadoopSerializationCoder(
  ...
  public void encode(T value, OutputStream outStream) throws IOException {
    final Serializer<T> serializer = serialization.getSerializer(type);
    serializer.open(new OutputStreamWrapper(outStream));
    try {
  ...
  public T decode(InputStream inStream) throws IOException {
    final Deserializer<T> deserializer = serialization.getDeserializer(type);
    deserializer.open(new InputStreamWrapper(inStream));
    try {
   ...
   *
   * @throws InvalidObjectException in case of invalid data
   */

...
public class ElasticsearchIO {
  ...
  public abstract static class ConnectionConfiguration implements Serializable {
    ...
    @Nullable
    public abstract String getClientKeystorePath();

    @Nullable
    public abstract String getClientKeystorePassword();

    @Nullable
    public abstract String getServerKeystorePath();

    @Nullable
    public abstract String getServerKeystorePassword();
    ...
    private void populateDisplayData(DisplayData.Builder builder) {
      ...
      builder.addIfNotNull(DisplayData.item("keystore.path", getClientKeystorePath()));
